...
var _data = {
	...
	"networks": {
		...
		'xing': {
			...
			'name': 'XING',
			'icons': {
				'oval': '\n      <svg version="1.1" width="512" height="512" viewBox="0 0 512 512">\n        <path d="M426.671 0h-341.328c-46.937 0-85.343 38.405-85.343 85.345v341.311c0 46.969 38.406 85.344 85.343 85.344h341.328c46.938 0 85.329-38.375 85.329-85.345v-341.31c0-46.94-38.391-85.345-85.329-85.345zM155.889 333.394h-55.632c-3.351 0-5.854-1.504-7.271-3.792-1.467-2.379-1.542-5.464 0-8.534l59.11-104.313c0.063-0.114 0.063-0.19 0-0.316l-37.615-65.116c-1.556-3.098-1.783-6.157-0.316-8.534 1.417-2.301 4.235-3.477 7.586-3.477h55.632c8.535 0 12.72 5.499 15.489 10.431 0 0 38.020 66.33 38.249 66.696-2.252 3.97-60.059 106.21-60.059 106.21-2.844 5.131-6.852 10.745-15.173 10.745zM418.956 75.269l-123.176 217.79c-0.075 0.115-0.075 0.255 0 0.367l78.431 143.295c1.556 3.084 1.593 6.221 0.113 8.597-1.415 2.288-4.033 3.552-7.383 3.552h-55.57c-8.522 0-12.783-5.663-15.54-10.596 0 0-78.848-144.646-79.050-145.023 3.944-6.98 123.797-219.523 123.797-219.523 2.984-5.362 6.587-10.596 14.894-10.596h56.203c3.351 0 5.981 1.265 7.396 3.553 1.466 2.376 1.428 5.511-0.115 8.584z"></path>\n      </svg>',
				'normal': '\n      <svg version="1.1" width="512" height="512" viewBox="0 0 512 512">\n        <path d="M256 0c-141.385 0-256 114.615-256 256s114.615 256 256 256 256-114.615 256-256-114.615-256-256-256zM172.741 320.203h-46.267c-2.788 0-4.87-1.247-6.049-3.146-1.219-1.976-1.282-4.533 0-7.080l49.162-86.535c0.052-0.095 0.052-0.158 0-0.263l-31.284-54.019c-1.294-2.569-1.483-5.106-0.263-7.079 1.179-1.909 3.522-2.885 6.31-2.885h46.267c7.1 0 10.579 4.562 12.884 8.654 0 0 31.62 55.025 31.809 55.328-1.873 3.295-49.95 88.11-49.95 88.11-2.366 4.258-5.699 8.915-12.619 8.915zM391.525 106.069l-102.441 180.672c-0.062 0.097-0.062 0.214 0 0.306l65.229 118.875c1.295 2.558 1.326 5.16 0.096 7.132-1.178 1.897-3.354 2.946-6.141 2.946h-46.217c-7.088 0-10.633-4.699-12.924-8.79 0 0-65.576-119.996-65.744-120.307 3.28-5.791 102.958-182.113 102.958-182.113 2.48-4.448 5.477-8.79 12.387-8.79h46.742c2.789 0 4.977 1.049 6.152 2.947 1.22 1.974 1.187 4.573-0.097 7.122z"></path>\n      </svg>'
			},
