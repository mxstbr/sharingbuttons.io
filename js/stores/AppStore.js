...
var _data = {
	...
	"networks": {
		...
		'wechat': {
			...
			'name': 'Wechat',
			'icons': {
				'normal': '<svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 0 24 24"> <path d="m18.9 19.5c-0.111-0.0628-0.243-0.0771-0.366-0.0409-0.694 0.205-1.44 0.317-2.23 0.317-3.61 0-6.53-2.39-6.53-5.33 0-2.95 2.92-5.33 6.53-5.33s6.53 2.39 6.53 5.33c0 1.63-0.892 3.08-2.3 4.06-0.113 0.0785-0.164 0.217-0.129 0.348l0.106 1.3c0.0921 0.344-1.62-0.651-1.62-0.651zm-12.5-3.85c1.11 0.292 2.06 0.368 3.07 0.363-0.173-0.5-0.266-1.03-0.266-1.57 0-3.21 3.21-5.82 7.18-5.82 0.139 0 0.277 0.00319 0.413 0.00947-0.589-3.06-3.83-5.39-7.75-5.39-4.33 0-7.85 2.86-7.85 6.39 0 1.94 1.06 3.68 2.74 4.85 0.158 0.11 0.23 0.304 0.18 0.488l-0.17 1.6c-0.11 0.4 1.92-0.8 1.92-0.8 0.16-0.1 0.37-0.1 0.5-0.1z" stroke-width="2"/><circle cx="6.36" cy="7.42" r=".5"/><circle cx="11.6" cy="7.51" r=".5"/><circle cx="14.1" cy="12.7" r=".5"/><circle cx="18.4" cy="12.7" r=".5"/></svg>',
				'solid': '<svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 0 24 24"><g fill-rule="evenodd"><path d="m19 14c0.54 0 0.98-0.43 0.98-0.96s-0.44-0.96-0.98-0.96-0.98 0.43-0.98 0.96 0.44 0.96 0.98 0.96zm-4.8 0c0.54 0 0.98-0.43 0.98-0.96s-0.44-0.96-0.98-0.96-0.98 0.43-0.98 0.96 0.44 0.96 0.98 0.96zm-2.7-5.6c0.64 0 1.2-0.51 1.2-1.1 0-0.62-0.52-1.1-1.2-1.1-0.64 0-1.2 0.51-1.2 1.1 0 0.62 0.52 1.1 1.2 1.1zm-5.8 0c0.64 0 1.2-0.51 1.2-1.1 0-0.62-0.52-1.1-1.2-1.1-0.64 0-1.2 0.51-1.2 1.1 0 0.62 0.52 1.1 1.2 1.1zm14 12c-0.12-0.069-0.27-0.085-0.4-0.045-0.77 0.23-1.6 0.35-2.5 0.35-4 0-7.2-2.6-7.2-5.9s3.2-5.9 7.2-5.9 7.2 2.6 7.2 5.9c0 1.8-0.99 3.4-2.5 4.5-0.12 0.087-0.18 0.24-0.14 0.39l0.34 1.3c0.1 0.38-0.099 0.53-0.45 0.33l-1.6-0.89zm-14-4.3c0.91 0.27 1.9 0.41 2.9 0.41 0.16 0 0.31-0.0034 0.47-0.01-0.19-0.55-0.29-1.1-0.29-1.7 0-3.6 3.6-6.4 7.9-6.4 0.15 0 0.31 0.0035 0.46 0.01-0.65-3.4-4.2-6-8.6-6-4.8 0-8.7 3.2-8.7 7.1 0 2.1 1.2 4.1 3 5.4 0.17 0.12 0.25 0.34 0.2 0.54l-0.41 1.5c-0.12 0.45 0.11 0.63 0.52 0.39l1.9-1.1c0.17-0.096 0.37-0.12 0.55-0.066z"/></svg>',
				'circle': '<svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 0 24 24"><g fill-rule="evenodd"><circle r="11" cy="12" cx="12" stroke-width="2"/><path stroke-linejoin="round" d="m16.5 17.1c-0.576-0.0177-1.26 0.138-1.77 0.188-2.47 0-4.47-1.63-4.47-3.63 0-2.01 2-3.63 4.47-3.63s4.47 1.63 4.47 3.63c0 1.11-0.611 2.1-1.57 2.77-0.191 0.39 0.1 0.969 0.19 1.35-0.4-0.2-0.9-0.4-1.3-0.7zm-8.57-2.62c1.72 0.297 2.42 0.403 2.33-0.887-0.0072-1.92 1.74-3.6 4.48-3.58-0.4-2.04-2.3-3.94-4.98-3.94-2.97 0-5.37 1.95-5.37 4.36 0 1.32 0.727 2.51 1.87 3.31 0.274 0.462-0.104 1.08-0.244 1.52 0.6-0.3 1.33-0.5 1.93-0.7z" stroke-width="2" fill="none"/><circle r=".5" cy="9" cx="7.9"/><circle r=".5" cy="9" cx="12"/><circle r=".5" cy="13" cx="13"/><circle r=".5" cy="13" cx="16"/></svg>',
				'solidcircle': '<svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 0 24 24"><g fill-rule="evenodd"><path d="m12 0a12 12 0 0 0 -12 12 12 12 0 0 0 12 12 12 12 0 0 0 12 -12 12 12 0 0 0 -12 -12zm-2.6 5c3.2 0 5.8 1.9 6.3 4.4-0.11-0.0051-0.22-0.0078-0.34-0.0078-3.2 0-5.8 2.1-5.8 4.7 0 0.44 0.075 0.87 0.21 1.3-0.11 0.005-0.23 0.008-0.34 0.008-0.75 0-1.5-0.11-2.1-0.3v0.002c-0.14-0.04-0.28-0.023-0.4 0.047l-1.4 0.78c-0.3 0.17-0.47 0.042-0.38-0.29l0.3-1.1c0.041-0.15-0.019-0.3-0.15-0.4-1.4-0.95-2.2-2.4-2.2-3.9 0-2.9 2.8-5.2 6.4-5.2zm5.9 4.8c2.9 0 5.3 1.9 5.3 4.3 0 1.3-0.72 2.5-1.9 3.3-0.091 0.064-0.13 0.18-0.11 0.28l0.25 0.93c0.075 0.28-0.073 0.39-0.33 0.24l-1.1-0.65c-0.09-0.051-0.2-0.063-0.3-0.033-0.56 0.17-1.2 0.26-1.8 0.26-2.9 0-5.3-1.9-5.3-4.3s2.4-4.3 5.3-4.3zm-1.8 2.2c-0.4 0-0.72 0.32-0.72 0.7 0 0.39 0.32 0.7 0.72 0.7s0.72-0.32 0.72-0.7c0-0.39-0.32-0.7-0.72-0.7zm3.5 0c-0.4 0-0.72 0.32-0.72 0.7 0 0.39 0.32 0.7 0.72 0.7s0.72-0.32 0.72-0.7c0-0.39-0.32-0.7-0.72-0.7z"/><circle cy="8.4" cx="7.2" r=".84"/><circle cy="8.4" cx="11" r=".84"/></g></svg>',
			},
